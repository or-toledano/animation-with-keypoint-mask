...
\begin{table}[t]
\caption{Motion transfer example}
\label{table:intro}
\vskip 0.15in
\begin{center}
\begin{small}
...
\toprule
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Driving_1.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Driving_2.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Driving_3.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Driving_4.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Driving_5.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Driving_6.png}\\
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Recon_1.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Recon_2.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Recon_3.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Recon_4.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Recon_5.png} &
\includegraphics[width=1cm, height=1cm]{paper/images/intro_image/Recon_6.png}\\
\bottomrule
\end{tabular}
\end{sc}
\end{small}
