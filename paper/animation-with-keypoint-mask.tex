...
\begin{table}[t]
\caption{\textbf{Motion transfer example:} Given a YouTube clip of a Thai-Chi artist (top), and an image of another one, our method transfers the one’s performance onto the other (bottom).}
\label{table:intro}
\vskip 0.15in
\begin{center}
\begin{small}
...
\includegraphics[width=1cm, height=1cm]{images/intro_image/Recon_1.png} &
\includegraphics[width=1cm, height=1cm]{images/intro_image/Recon_2.png} &
\includegraphics[width=1cm, height=1cm]{images/intro_image/Recon_3.png} &
