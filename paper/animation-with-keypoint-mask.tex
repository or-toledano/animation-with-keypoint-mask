...
any domain. Keeping the generator as a frame processor keeps it simple,
but there were other works \cite{villegas2017learning} which make
a use of LSTM.
...
The first version is referred as a "keypoint heatmap," while the second is
referred as a "circles mask" or "keypoints after softmax".
...
However, our approach did follow the driving video well, and to improve the
