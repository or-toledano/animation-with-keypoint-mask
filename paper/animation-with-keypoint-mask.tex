...
\toprule
 \includegraphics[width=1cm, height=1cm]{paper/images/source.JPG}& \includegraphics[width=1cm, height=1cm]{paper/images/driving1.JPG} & \includegraphics[width=1cm, height=1cm]{paper/images/driving2.JPG} & \includegraphics[width=1cm, height=1cm]{paper/images/driving3.JPG} & \includegraphics[width=1cm, height=1cm]{paper/images/driving4.JPG}&
\includegraphics[width=1cm, height=1cm]{paper/images/driving5.JPG}\\
\midrule
X2Face & \includegraphics[width=1cm, height=1cm]{paper/images/1_X2Face_1.JPG} & \includegraphics[width=1cm, height=1cm]{paper/images/1_X2Face_2.JPG} &
