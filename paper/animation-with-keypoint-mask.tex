...
\toprule
 \includegraphics[width=1cm, height=1cm]{images/source.JPG}& \includegraphics[width=1cm, height=1cm]{images/driving1.JPG} & \includegraphics[width=1cm, height=1cm]{images/driving2.JPG} & \includegraphics[width=1cm, height=1cm]{images/driving3.JPG} & \includegraphics[width=1cm, height=1cm]{images/driving4.JPG}&
\includegraphics[width=1cm, height=1cm]{images/driving5.JPG}\\
\midrule
X2Face & \includegraphics[width=1cm, height=1cm]{images/1_X2Face_1.JPG} & \includegraphics[width=1cm, height=1cm]{images/1_X2Face_2.JPG} &
