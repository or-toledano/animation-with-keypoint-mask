...
based on the implemantation of \cite{wang2018videotovideo}. With the input
driving frame $D$ and the corresponding recontructed frame $\hat{D}$, the
...
\subsubsection{Qualititive comparison}
...
In addition, the red decoration in the background is consitant in
...
irrelavent parts for the motion.
